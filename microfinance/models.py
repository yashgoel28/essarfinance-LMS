...
class Clients(models.Model):
    ...
    Father_Name = models.CharField(max_length=100,default='',null=True,blank=True)
    Husband_Name = models.CharField(max_length=100,default='',null=True,blank=True)
    Mother_Name = models.CharField(max_length=100,default='',null=True,blank=True)
    Wife_Name = models.CharField(max_length=100,default='',null=True,blank=True)
...
class Loans(models.Model):
    ...
    remark = models.CharField(max_length=100,default='None',blank=True)
...
class Installments(models.Model):
    ...
    def __str__(self):
       return str(self.Date_Due) +" - "+str(self.Date_Paid)+ " - "+str(self.Loan.pk)  
    class Meta:
...
class Penalty(models.Model):
    ...
    Date_Started = models.DateField(default=None,null=True)
...
class IntrestLoans(models.Model):
    Principle_Amount = models.FloatField()
    Intrest_Rate = models.FloatField(default=20)
    File_Charge_Percent =models.FloatField(default=5)
    First_Due_Date =  models.DateField(default=timezone.now)
    ...
    Status =models.BooleanField(default=False)
    reminder = models.DateField(default=datetime.now(),blank=True,null=True)
    Balance_Principle_Amount = models.FloatField()
    Intrest_Generated = models.FloatField(default=0)
...
class IntAndEffectivePA(models.Model):
    Loan=models.ForeignKey(IntrestLoans,on_delete=models.PROTECT,default=0)
    Date = models.DateField(default=None)
    Effective_Principle = models.FloatField(default=0)
    Monthly_Intrest = models.FloatField(default=0)
    def __str__(self):
       return str(self.Date)+ " - "+str(self.Loan.pk)  

class IntrestInstallments(models.Model):
    Loan=models.ForeignKey(IntrestLoans,on_delete=models.PROTECT,default=0)
    Date_Paid = models.DateField(default=None, null=True,blank=True)
    Installment_Paid = models.FloatField(default=0)
    def __str__(self):
       return str(self.Date_Paid)+ " - "+str(self.Loan.pk)  
    class Meta:
        ordering = ['Loan_id','Date_Paid','-Installment_Paid']
